...
@XmlRootElement(name = "GetResults", namespace = "http://hl7.paml.com/ws/")
public class GetResults {
     ...
     * 
     */
    public GetResults(final ResultRequest resultRequest) {
    ...
    public GetResults withResultRequest(ResultRequest value) {
